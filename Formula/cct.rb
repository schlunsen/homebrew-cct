class Cct < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/schlunsen/claude-control-terminal/releases/download/v0.1.0/cct-darwin-arm64"
      sha256 "a08cd0700905c9abf7ccc35046c79be248e73c18c726a9b3ad5df26a0314b318"
    else
      url "https://github.com/schlunsen/claude-control-terminal/releases/download/v0.1.0/cct-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/schlunsen/claude-control-terminal/releases/download/v0.1.0/cct-linux-arm64"
      sha256 "4fc1a64e95c760b66a011f7db92f110f31b73b41b5d05eb0c81c8ee46141ed50"
    else
      url "https://github.com/schlunsen/claude-control-terminal/releases/download/v0.1.0/cct-linux-amd64"
